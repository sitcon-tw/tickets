...
export const registrations = {
	 ...
	 */
	update: (id, data) =>
		adminApiRequest(`/registrations/${id}`, {
			method: "PUT",
	...
	updateStatus: (id, status) =>
		adminApiRequest(`/registrations/${id}/status`, {
			method: "PUT",
...
export const tickets = {
	...
	update: (ticketId, data) =>
		adminApiRequest(`/tickets/${ticketId}`, {
			method: "PUT",
			body: JSON.stringify(data)
		}),
...
export const formFields = {
	 ...
	 */
	create: data =>
		adminApiRequest("/ticket-form-fields", {
			method: "POST",
			body: JSON.stringify(data)
		}),
	 ...
	 */
	update: (fieldId, data) =>
		adminApiRequest(`/ticket-form-fields/${fieldId}`, {
			method: "PUT",
			body: JSON.stringify(data)
		}),
	 ...
	 */
	reorder: fieldOrders =>
		adminApiRequest("/ticket-form-fields/reorder", {
			method: "PUT",
...
export const invitationCodes = {
	 ...
	 */
	create: data =>
		adminApiRequest("/invitation-codes", {
			method: "POST",
			body: JSON.stringify(data)
		}),
	 ...
	 */
	update: (id, data) =>
		adminApiRequest(`/invitation-codes/${id}`, {
			method: "PUT",
			body: JSON.stringify(data)
		}),
	 ...
	 */
	bulkCreate: data =>
		adminApiRequest("/invitation-codes/bulk", {
			method: "POST",
			body: JSON.stringify(data)
		})
};
