																				...
																				{condition.type === "time" && (
																					<>
																						<div>
																							...
																							<Input
																								type="datetime-local"
																								value={condition.startTime ? toDateTimeLocalString(condition.startTime) : ""}
																								onChange={e => {
																									const newConditions = [...(q.filters!.conditions || [])];
																									newConditions[condIndex] = {
																										...condition,
																										startTime: e.target.value ? new Date(fromDateTimeLocalString(e.target.value)) : undefined
																									};
																									updateQuestion(q.id, {
																										filters: {
																											...q.filters!,
																						...
																						<div>
																							...
																							<Input
																								type="datetime-local"
																								value={condition.endTime ? toDateTimeLocalString(condition.endTime) : ""}
																								onChange={e => {
																									const newConditions = [...(q.filters!.conditions || [])];
																									newConditions[condIndex] = {
																										...condition,
																										endTime: e.target.value ? new Date(fromDateTimeLocalString(e.target.value)) : undefined
																									};
																									updateQuestion(q.id, {
																										filters: {
																											...q.filters!,
