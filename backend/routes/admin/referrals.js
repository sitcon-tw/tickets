...
export default async function adminReferralsRoutes(fastify, options) {
  ...
  // 推薦機制總覽統計
  fastify.get('/referrals/overview',
  { schema: {
  ...
  // 推薦排行榜
  fastify.get('/referrals/leaderboard',
  { schema: {
    description: '推薦排行榜',
    tags: ['admin-referrals'],
  }},
  ...
  // 獲取推薦擴譜圖數據
  fastify.get('/referrals/tree/:regId',
  { schema: {
  ...
  // 獲取達標推薦者名單
  fastify.get('/referrals/qualified',
  { schema: {
