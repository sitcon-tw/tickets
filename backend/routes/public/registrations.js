...
export default async function registrationsRoutes(fastify, options) {
  ...
  // 表單預驗證
  fastify.post('/registrations/validate',
  { schema: {
  ...
  // 請求編輯連結
  fastify.post('/registrations/request-edit',
  { schema: {
  ...
  // 驗證編輯 token
  fastify.get('/registrations/verify-edit',
  { schema: {
  ...
  // 透過驗證後進入編輯頁面
  fastify.get('/registrations/edit/:token',
  { schema: {
  ...
  // 提交編輯後的資料
  fastify.put('/registrations/edit/:token',
  { schema: {
  ...
  // 取消報名
  fastify.post('/registrations/cancel/:token',
  { schema: {
    description: '取消報名',
    tags: ['registrations'],
  }},
  ...
  // 獲取專屬推薦連結
  fastify.get('/registrations/:regId/referral-link',
  { schema: {
  ...
  // 獲取個人推薦統計
  fastify.get('/registrations/referral-stats/:regId',
  { schema: {
